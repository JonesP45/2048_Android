...
public class ModeleJeu {
    ...
    public void load(int score, int scoreN_1, State state, Cellule[][] grille, Cellule[][] grilleN_1, boolean premierCoupFait, boolean undoDejaFait) {
        this.score = score;
        this.scoreN_1 = scoreN_1;
        this.state = state;
        this.grille = grille;
        this.grilleN_1 = grilleN_1;
        this.premierCoupFait = premierCoupFait;
        this.undoDejaFait = undoDejaFait;
        this.listeCaseVide.clear();
        Cellule cellule = new Cellule();
        for (int i = 0; i < tailleGrille; i++) {
            for (int j = 0; j < tailleGrille; j++) {
                if (this.grille[i][j].getValeur() == cellule.getValeur()) {
                    ajouterCaseVide(i, j);
                }
            }
        }
...
//        afficheGrille();
    ...
    public Cellule[][] getGrilleN_1() {
        return grilleN_1;
    }
    public State getState() {
        return state;
    }
    public boolean isPremierCoupFait() {
        return premierCoupFait;
    }
    public boolean isUndoDejaFait() {
        return undoDejaFait;
    }
}
...
//    }
//
//    private ModeleJeu modeleJeuN_1;
//
//    private State state;
//    private Cellule[][] grille;
//    private Cellule[][] grilleN_1;//
